...
class TestTextNode(unittest.TestCase):
    ...
    def test_url_not_equal(self):
        node = TextNode("Text", TextType.LINK, url="https://example.com")
...
class TestTextNodeToHTML(unittest.TestCase):
    ...
    def test_text_with_url(self):
        node = TextNode("This is a text node", TextType.LINK, "https://www.lipsum.com")
        html_node = text_node_to_html_node(node)
        self.assertEqual(html_node.tag, "a")
        self.assertEqual(html_node.value, "This is a text node")
        self.assertEqual(html_node.props, {"href": "https://www.lipsum.com"})
